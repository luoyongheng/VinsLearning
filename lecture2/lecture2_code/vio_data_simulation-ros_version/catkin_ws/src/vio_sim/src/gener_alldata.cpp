...
int main(int argc, char** argv)
{
    ...
    rosbag::Bag bag;
    bag.open("/home/luoyongheng/CLionProjects/VinsLearning/lecture2/lecture2_code/vio_data_simulation-ros_version/catkin_ws/src/vio_sim/data/imu.bag", rosbag::bagmode::Write);
